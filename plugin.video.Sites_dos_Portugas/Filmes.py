...
def FILMES_pesquisar(nome_pesquisa):
	...
	FILMES_encontrar_fontes_pesquisa_FTT(url_pesquisa)
	a = 4
	...
	FILMES_encontrar_fontes_pesquisa_CMT(url_pesquisa)
...
def FILMES_encontrar_fontes_pesquisa_FTT(url):
        if selfAddon.getSetting('movies-view') == "0":
                addDir1('[B][COLOR green]TUGA[/COLOR][COLOR yellow]-[/COLOR][COLOR red]FILMES[/COLOR][/B].tv','url',1020,artfolder,False,'')
	try:
		html_source = abrir_url(url)
...
def FILMES_encontrar_fontes_pesquisa_CMT(url):
        if selfAddon.getSetting('movies-view') == "0":
                addDir1('[B][COLOR green]TUGA[/COLOR][COLOR yellow]-[/COLOR][COLOR red]FILMES[/COLOR][/B].tv','url',1020,artfolder,False,'')
	try:
		html_source = abrir_url(url)

...
def TFV_MenuPrincipal(artfolder):
	...
	addDir('[COLOR yellow]Menu Filmes[/COLOR]','url',37,artfolder + 'banner.png','nao','')
	addDir('[COLOR yellow]Menu Séries[/COLOR]','url',40,artfolder + 'banner.png','nao','')
	addDir('[COLOR yellow]Filmes Animação[/COLOR]','http://www.tuga-filmes.tv/search/label/Anima%C3%A7%C3%A3o',32,artfolder + 'banner.png','nao','')
        addDir('[COLOR yellow]Recentes[/COLOR]','http://www.tuga-filmes.tv',32,artfolder + 'banner.png','nao','')
        addDir1('','','',artfolder + 'banner.png',False,'')
	addDir('Pesquisar','http://www.tuga-filmes.tv/search?q=',34,artfolder + 'banner.png','nao','')
	addDir('[COLOR brown]ChangeLog[/COLOR]','http://o-repositorio-maluco.googlecode.com/svn/trunk/changelogs/changelog_TugaFilmesTV.txt',57,artfolder + 'banner.png','nao','')
 
def TFV_Menu_Filmes(artfolder):
        addDir1('[B][COLOR blue]Menu Filmes[/COLOR][/B]','','',artfolder + 'banner.png',False,'')
        addDir1('','','',artfolder + 'banner.png',False,'')
	addDir('[COLOR yellow]Ver Todos[/COLOR]','http://www.tuga-filmes.tv/search/label/Filmes',32,artfolder + 'banner.png','nao','')
        addDir('[COLOR yellow]Ver por Ano[/COLOR]','url',39,artfolder + 'banner.png','nao','')
	addDir('[COLOR yellow]Categorias[/COLOR]','url',38,artfolder + 'banner.png','nao','')
	addDir('[COLOR yellow]Top 5 da Semana[/COLOR]','url',48,artfolder + 'banner.png','nao','')
	if selfAddon.getSetting('hide-porno') == "false":
			addDir('[B][COLOR red]M+18[/B][/COLOR]','url',49,artfolder + 'banner.png','nao','')
        addDir1('','','',artfolder + 'banner.png',False,'')
	addDir('Pesquisar','http://www.tuga-filmes.tv/search?q=',34,artfolder + 'banner.png','nao','')
...
def TFV_Menu_Series(artfolder):
        ...
        addDir1('','','',artfolder + 'banner.png',False,'')
	addDir('[COLOR yellow]A a Z[/COLOR]','url',41,artfolder + 'banner.png','nao','')
        addDir('[COLOR yellow]Recentes[/COLOR]','http://www.tuga-filmes.tv/search/label/Séries',44,artfolder + 'banner.png','nao','')
        addDir1('','','',artfolder + 'banner.png',False,'')
	addDir('Pesquisar','http://www.tuga-filmes.tv/search?q=',34,artfolder + 'banner.png','nao','')

def TFV_Menu_M18(artfolder):
	...
	addDir('[COLOR yellow]Categorias[/COLOR]','url',50,artfolder + 'banner.png','nao','')
        ...
        addDir1('','','',artfolder + 'banner.png',False,'')
	addDir('Pesquisar','http://extraporn.net/?s=',56,artfolder + 'banner.png','nao','')
...
def TFV_Menu_Filmes_Por_Ano(artfolder):
	...
	for endereco_ano,nome_ano,num_filmes_ano in filmes_por_ano:
		addDir('[COLOR yellow]' + nome_ano + '[/COLOR] ' + num_filmes_ano,endereco_ano,32,artfolder + 'banner.png','nao','')
	...
	html_items_categorias = re.findall("<div class=\'widget Label\' id=\'Label1\'>\n<h2>Categorias</h2>(.*?)<div class=\'clear\'>", html_categorias_source, re.DOTALL)
        ...
        for item_categorias in html_items_categorias:
                ...
                for endereco_categoria,nome_categoria in filmes_por_categoria:
                        addDir('[COLOR yellow]' + nome_categoria + '[/COLOR] ',endereco_categoria,32,artfolder + 'banner.png','nao','')
	...
	html_items_series = re.findall("<div class=\'widget Label\' id=\'Label3\'>\n<h2>S\xc3\xa9ries(.*?)<div class=\'clear\'>", html_series_source, re.DOTALL)
        ...
        for item_series in html_items_series:
                ...
                for endereco_series,nome_series in series:
                        ...
                        nome_series = nome_series.replace('&#39;',"'")
                        addDir('[COLOR yellow]' + nome_series + '[/COLOR] ',endereco_series,47,artfolder + 'banner.png','nao','')

def TFV_Menu_M18_Categorias(artfolder):
...
def TFV_Menu_M18_30_Recentes(artfolder):
        url_recente = 'http://extraporn.net/'
        html_recente_source = TFV_abrir_url(url_recente)
	html_items_recente = re.findall('<div id="recent-posts-3" class="widget_recent_entries">(.*?)<!--/sidebar-->', html_recente_source, re.DOTALL)
        ...
        for item_recente in html_items_recente:
                ...
                for endereco_recente,nome_recente in filmes_por_recente:
                        ...
                        nome_recente = nome_recente.replace('&#8211;',"-")
                        addDir('[COLOR yellow]' + nome_recente + '[/COLOR] ',endereco_recente,55,artfolder + 'banner.png','nao','')
...
def TFV_pesquisar():
	...
	if (keyb.isConfirmed()):
		...
		TFV_encontrar_fontes_pesquisa(url_pesquisa,pesquisou)

def TFV_pesquisar_M18():
	keyb = xbmc.Keyboard('', 'Escreva o parâmetro de pesquisa')
	keyb.doModal()
	if (keyb.isConfirmed()):
		search = keyb.getText()
		...
		pesquisou = str(encode)
		TFV_encontrar_fontes_pesquisa_M18(url_pesquisa,pesquisou)

def TFV_encontrar_fontes_pesquisa(url,pesquisou):
	...
	addDir1('','','',artfolder + 'banner.png',False,'')
	addDir('Nova Pesquisa','http://www.tuga-filmes.tv/search?q=',34,artfolder + 'banner.png','nao','')
	#addDir('[COLOR yellow]Menu Anterior >>[/COLOR]','url',37,artfolder + 'banner.png','','')

def TFV_encontrar_fontes_pesquisa_M18(url,pesquisou):
        pesquisado = pesquisou.replace('%20',' ')
        addDir1('[B][COLOR blue]Pesquisou : [/COLOR]( ' + pesquisado + ' )[/B]','','',artfolder + 'banner.png',False,'')
        addDir1('','','',artfolder + 'banner.png',False,'')
	try:
	...
	if items != []:
		...
		for item in items:
			...
			nome = nome.replace('&#8217;',"'")
                        nome = nome.replace('&#8211;',"-")
			try:
				addDir(nome,urletitulo[0][0],55,thumbnail[0].replace('s72-c','s320'),'','')
			except: pass
	else:
...
def TFV_encontrar_fontes_filmes(url,artfolder):
	...
	if proxima[0] != '':
                try:
                        addDir1('','','',artfolder + 'banner.png',False,'')
                        addDir("[B]Página Seguinte >>[/B]",proxima[0],32,artfolder + 'banner.png','','')
                except:pass
...
def TFV_encontrar_fontes_series_recentes(url):
	...
	proxima = re.compile(".*href=\'(.+?)\' id=\'Blog1_blog-pager-older-link\'").findall(html_source)
        try:
                addDir1('','','',artfolder + 'banner.png',False,'')
                addDir("Página Seguinte >>",proxima[0],44,artfolder + 'banner.png','','')
        except: pass
...
def TFV_encontrar_fontes_M18(url):
	try:
		html_source = TFV_abrir_url(url)
	except: html_source = ''
	items = re.findall('<div class="boxentry">(.*?)<div class="boxmetadata">', html_source, re.DOTALL)
...
def TFV_encontrar_videos_M18(name,url):
        conta_id_video = 0
...
def TFV_play_movie(url,name,iconimage,checker,fanart):
        if "vidto.me" in url:
		try:
			sources = []
	...
	if "dropvideo" in url:
		try:
			iframe_url = url
			print iframe_url
			link3 = TFV_abrir_url(iframe_url)
...
def TFV_TextBoxes(url):
        texto = ''
        try:
                texto_url = TFV_abrir_url(url)
        except: texto_url = ''
...
if mode==None or url==None or len(url)<1:
        print ""
        TFV_MenuPrincipal(artfolder)

elif mode == 30: print ""; TFV_play_movie(url,name,iconimage,checker,fanart)
elif mode == 31: TFV_MenuPrincipal(artfolder)
elif mode == 32: TFV_encontrar_fontes_filmes(url,artfolder)
elif mode == 33: TFV_encontrar_videos_filmes(name,url)
elif mode == 34: TFV_pesquisar()
elif mode == 35: TFV_resolve_videomega_filmes(url,conta_id_video)
elif mode == 36: TFV_resolve_not_videomega_filmes(name,url,id_video,conta_id_video,nome_fonte_video)
elif mode == 37: TFV_Menu_Filmes(artfolder)
elif mode == 38: TFV_Menu_Filmes_Por_Categorias(artfolder)
elif mode == 39: TFV_Menu_Filmes_Por_Ano(artfolder)
elif mode == 40: TFV_Menu_Series(artfolder)
elif mode == 41: TFV_Menu_Series_A_a_Z(artfolder)
elif mode == 42: TFV_encontrar_videos_series(name,url)
elif mode == 43: TFV_resolve_not_videomega_series(name,url,id_video,nome_cada_episodio,src_href)
elif mode == 44: TFV_encontrar_fontes_series_recentes(url)
elif mode == 45: TFV_pesquisar_series()
elif mode == 46: TFV_encontrar_fontes_pesquisa(url,pesquisou)
elif mode == 47: TFV_encontrar_fontes_series_A_a_Z(url)
elif mode == 48: TFV_Menu_Filmes_Top_5(artfolder)
elif mode == 49: TFV_Menu_M18(artfolder)
elif mode == 50: TFV_Menu_M18_Categorias(artfolder)
elif mode == 51: TFV_Menu_M18_30_Recentes(artfolder)
elif mode == 52: TFV_encontrar_fontes_M18(url)
elif mode == 53: TFV_encontrar_videos_M18(name,url)
elif mode == 54: TFV_pesquisar_M18()
elif mode == 55: TFV_encontrar_fontes_pesquisa_M18(url,pesquisou)
elif mode == 56: TFV_ChangeLog()
elif mode == 57: TFV_TextBoxes(url)

                        ...
                        for url in urlvideo:
                                if 'youtube' not in url:
                                        ...
                                        if 'videomega' in url:
                                                try:
                                                        fonte_id = '(Videomega)'
                                                        addDir('[B]- Fonte ' + str(conta_id_video) + ' : [COLOR yellow](Videomega)[/COLOR][/B]',urlvideomega,30,iconimage,'',fanart)
                                                except: pass
                                        else:
...
def CMT_resolve_not_videomega_filmesll(url,conta_id_video,conta_os_items,nomeescolha,fanart,iconimage):
        url = url + '///' + nomeescolha
        if "videomega" in url:
		try:
                        fonte_id = '(Videomega)'
